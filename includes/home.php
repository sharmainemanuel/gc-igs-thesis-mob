...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="#"><em class="fa fa-calendar">&nbsp;</em> Profile</a></li>
			<li><a href="#"><em class="fa fa-bar-chart">&nbsp;</em> Subject</a></li>
			<li><a href="payment.php"><em class="fa fa-toggle-off">&nbsp;</em> Payment</a></li>
